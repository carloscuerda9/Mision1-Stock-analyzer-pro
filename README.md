...
<p align="center">
  <img src="https://github.com/carloscuerda9/Mision1-tock-analyzer-pro/assets/157844996/ad483781-160b-44e1-805a-8007749c1e69" width="50%">
...
Nota: La inspiración original provino de un proyecto en el curso de Análisis de Datos (Iron Hack), mi trabajo se centra específicamente en el análisis avanzado de acciones mediante la API de Yahoo Finance

<h3>Contenido: </h3>
Dentro de este repositorio, encontrarás una pestaña con el código que he desarrollado, detallando el proceso de limpieza de datos y explicando las diferentes fórmulas o métodos usados en el proceso. Además, incluyo link con una presentación en Canva de la idea de aplicación que visualiza el proyecto en su conjunto.
